-- Create savings table (metas de ahorro)
...
-- Create savings_deposits table (depósitos a ahorros)
...
CREATE POLICY "Users can manage own savings_deposits" ON savings_deposits
  FOR ALL USING (true);